...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HMR Pharmacists Exchange" },
      { name: "description", content: "Connect with HMR Pharmacists Australia Wide" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "HMR Pharmacists Exchange" },
      { property: "og:description", content: "Connect with HMR Pharmacists Australia Wide" },
