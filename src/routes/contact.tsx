    ...
    <SiteShell>
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 text-muted-foreground">
          For platform questions, partnership enquiries, or feedback. For clinical questions, please
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[260px_1fr]">
          <div className="space-y-4">
            <Item
              ...
              title="Email"
              body="hello@hmrpharmacists.com.au"
            />
            <Item
              icon={<MessageSquare className="h-4 w-4" />}
              title="Response time"
              body="We aim to respond within 2 business days."
            />
          </div>
          ...
          >
            ...
            <div>
              ...
              <Textarea className="mt-1.5 min-h-32" required />
            </div>
