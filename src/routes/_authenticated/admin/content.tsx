  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Author and publish marketing & guidance pages.
          </p>
        </div>
      ...
      <Card className="divide-y divide-border">
        {pages.length === 0 && (
          <p className="p-8 text-center text-sm text-muted-foreground">No pages yet.</p>
        )}
        {pages.map((p) => (
          <div key={p.id} className="grid gap-3 p-4 sm:grid-cols-[1fr_auto] sm:items-center">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Updated {new Date(p.updated_at).toLocaleString("en-AU")}
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => setEditing({ ...p, body: p.body?.markdown ?? "" })}
              >
                Edit
              </Button>
              <Button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  value={
                    typeof editing.body === "string" ? editing.body : (editing.body?.markdown ?? "")
                  }
